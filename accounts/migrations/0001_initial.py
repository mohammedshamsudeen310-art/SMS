# Generated by Django 5.1.7 on 2025-10-06 15:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'Super Administrator'), ('admin', 'Administrator / Principal'), ('teacher', 'Teacher'), ('student', 'Student'), ('accountant', 'Accountant'), ('parent', 'Parent / Guardian')], default='student', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('child', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parents', to='accounts.studentprofile')),
            ],
            options={
                'abstract': False,
            },
